...
if typing.TYPE_CHECKING:
  ...
  import bsb.connectivity.point_cloud.cloud_cloud_intersection
  import bsb.connectivity.point_cloud.cloud_mesh_utils
  import bsb.connectivity.point_cloud.cloud_morphology_intersection
  import bsb.connectivity.point_cloud.geometric_shapes
  import bsb.connectivity.point_cloud.morphology_cloud_intersection
  import bsb.core
...
CloudHemitype: typing.Type["bsb.connectivity.CloudHemitype"]
CloudToCloudIntersection: typing.Type["bsb.connectivity.CloudToCloudIntersection"]
CloudToMorphologyIntersection: typing.Type["bsb.connectivity.CloudToMorphologyIntersection"]
...
Cone: typing.Type["bsb.connectivity.Cone"]
...
Cuboid: typing.Type["bsb.connectivity.Cuboid"]
Cylinder: typing.Type["bsb.connectivity.Cylinder"]
...
Ellipsoid: typing.Type["bsb.connectivity.Ellipsoid"]
...
GeometricShape: typing.Type["bsb.connectivity.GeometricShape"]
...
MorphologyToCloudIntersection: typing.Type["bsb.connectivity.MorphologyToCloudIntersection"]
...
Parallelepiped: typing.Type["bsb.connectivity.Parallelepiped"]
...
ShapesComposition: typing.Type["bsb.connectivity.ShapesComposition"]
...
Sphere: typing.Type["bsb.connectivity.Sphere"]
