...
class ConnectomeGolgiGlomerulus(TouchingConvergenceDivergence):
    ...
    def connect(self):
        ...
        def connectome_goc_glom(first_glomerulus, glomeruli, golgicells, GoCaxon_x, GoCaxon_y, GoCaxon_z, r_glom,
...
class ConnectomeBCSCPurkinje(ConnectionStrategy):
    ...
    def connect(self):
        ...
        result_sc, result_bc = connectome_sc_bc_pc(first_stellate, first_basket, baskets, stellates, purkinjes, distx,
                                                   distz, conv)
        self.scaffold.connect_cells(self, result_sc, self.tag_sc, meta={'from_cell_types': [stellate_cell_type.name]})
        self.scaffold.connect_cells(self, result_bc, self.tag_bc, meta={'from_cell_types': [basket_cell_type.name]})
